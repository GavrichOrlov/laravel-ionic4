...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::any('mapimplement', 'SearchController@mapimplement')->name('mapimplement');
    Route::any('payment', 'SearchController@payment')->name('payment');
    Route::any('requestmanage', 'SearchController@requestmanage')->name('requestmanage');
});
...
Route::any('getdrivertypes', 'IonicapiController@getdrivertypes')->name('getdrivertypes');
Route::any('getdriver', 'IonicapiController@getdriver')->name('getdriver');
Route::any('getdriverlocation', 'IonicapiController@getdriverLocation')->name('getdriverlocation');
...
Route::post('canceltrip', 'IonicapiController@cancelTripByrider')->name('canceltrip');
...
Route::post('canceltripbydriver', 'IonicapiController@cancelTripBydriver')->name('canceltripbydriver');
Route::post('arrivedtrip', 'IonicapiController@arrivedTrip')->name('arrivedtrip');

//Bako added
Route::any('ridergivenfeedback', 'IonicapiController@ridergivenfeedback')->name('ridergivenfeedback');
Route::any('drivergivenfeedback', 'IonicapiController@drivergivenfeedback')->name('drivergivenfeedback');
Route::any('driverhistory', 'IonicapiController@driverhistory')->name('driverhistory');
Route::any('carinfoGet', 'IonicapiController@carinfoGet')->name('carinfoGet');
Route::any('carinfoPut', 'IonicapiController@carinfoPut')->name('carinfoPut');
Route::any('carinfoGetbyID', 'IonicapiController@carinfoGetbyID')->name('carinfoGetbyID');
Route::any('carActive', 'IonicapiController@carActive')->name('carActive');
Route::any('driverfeedbackView', 'IonicapiController@driverfeedbackView')->name('driverfeedbackView');